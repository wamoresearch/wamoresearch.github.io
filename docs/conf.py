...
BLOG_AUTHOR = "Wamo Group"  # (translatable)
BLOG_TITLE = "Wave Modelling Research Group"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wamoresearch.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://wamoresearch.github.io/"
BLOG_EMAIL = "martin.richter@nottingham.ac.uk"
BLOG_DESCRIPTION = "Home of the Wave Modelling Research Group at the University of Nottingham, UK"  # (translatable)
